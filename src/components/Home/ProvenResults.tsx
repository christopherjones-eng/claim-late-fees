  ...
  return (
    <section className="section-padding hero-gradient text-primary-foreground">
      <div className="container-custom">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-primary-foreground">£2.3M+</div>
              <div className="text-primary-foreground/70">Money Recovered</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-primary-foreground">94%</div>
        ...
        {/* How It Works */}
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-primary-foreground text-center mb-12">
            How It Works
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-primary-foreground mb-2">Submit Your Claim</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-primary-foreground mb-2">We Take Action</h4>
              <p className="text-primary-foreground/80">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-primary-foreground mb-2">Get Paid</h4>
              <p className="text-primary-foreground/80">
