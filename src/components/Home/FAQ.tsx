      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-subtitle text-muted-foreground mb-12">
            Everything you need to know about our debt recovery service
          </p>
        </div>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              <AccordionItem 
                key={index} 
                value={`item-${index}`}
                className="card-professional border-0 shadow-sm hover:shadow-lg transition-shadow duration-300"
              >
